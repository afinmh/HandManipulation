1. Install library
Install beberapa library yang diperlukan dengan melakukan 
copy sintaks berikut ke terminal
pip install -r requirements.txt

2. Usage
run file final.py
jika ingin mencoba program terpisah 
jalankan file pada folder dummy

3. Optimalisasi
Untuk Interface yang sempurna, ubah resolusi layar menjadi 1366x768 atau yang mendekati
